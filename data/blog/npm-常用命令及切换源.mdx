...
draft: false
summary: >-
  npm node package manager——网站 npmjs.com 只要安装了 node 就安装了 npm nm 也有版本概念 一些常用命令
  npm init //生成 package.json 文件 npm init y //快速生成 跳过向导 npm install 包名 //下载 npm
  install
authors:
  - default
---
...
![nrm-ls](/static/blog/npm-常用命令及切换源/nrm-ls.png)
...
![nrm-add](/static/blog/npm-常用命令及切换源/nrm-add.png)
...
![nrm-del](/static/blog/npm-常用命令及切换源/nrm-del.png)

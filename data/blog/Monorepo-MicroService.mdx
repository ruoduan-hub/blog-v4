...
draft: false
summary: >-
  缘起 最近经常看到 Monorepo 和 MicroService 被提及这里做一下总结 What is it Monorepo: 是指单一代码库
  在版本控制系统的单个代码库里包含了多个项目之间的代码，项目之间可能是相关的，但通常在逻辑上是独立的，可以有单个或者多个不同的团队维护。 那既然有
  单一代码库与之对应的就是多
authors:
  - default
---
...
<img src="https://s2.loli.net/2022/05/13/QdfNZiORE6S8eAb.jpg" alt="microservices architecture" data-zoom="67" />
...
<img src="https://s2.loli.net/2022/05/14/tcLASQiBG8sexEl.jpg" alt="mfe-structure.4b7628a6" data-zoom="50" />

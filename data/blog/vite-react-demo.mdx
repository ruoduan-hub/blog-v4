...
draft: false
summary: >-
  This Vite Vite 以 原生 ESM 方式服务源码。这实际上是让浏览器接管了打包程序的部分工作：Vite
  只需要在浏览器请求源码时进行转换并按需提供源码。根据情景动态导入的代码，即只在当前屏幕上实际使用时才会被处理。 老规矩脚手架 根据提示操作 我这边选择的是
  reactts 模板 完成这一步后会生成一个项目
authors:
  - default
---

## This Vite
> Vite 以原生 ESM 方式服务源码。这实际上是让浏览器接管了打包程序的部分工作：Vite 只需要在浏览器请求源码时进行转换并按需提供源码。
...
<img src="https://i.loli.net/2021/09/15/aDgMb1OtRQFnm5W.jpg" alt="demo-app" data-zoom="50" />
...
<img src="https://i.loli.net/2021/09/15/MFIDozpZK4ShnYC.jpg" alt="demo" data-zoom="50" />

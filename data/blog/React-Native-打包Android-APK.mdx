...
draft: false
summary: >-
  ReactNative 打包 Android.APK 1. 生成签名秘钥 输入一些必要信息 name password ... 1.1 直接使用
  Android studio 进行签名 傻瓜式 next 不做赘述 2、设置 gradle 变量： 修改 android/gradle.properties
  文件，增加如下 
authors:
  - default
---
...
```shell MYAPP_RELEASE_STORE_FILE="my-release-key.keystore" MYAPP_RELEASE_KEY_ALIAS="my-key-alias" MYAPP_RELEASE_STORE_PASSWORD="xx" MYAPP_RELEASE_KEY_PASSWORD="xx"
